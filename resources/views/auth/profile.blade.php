                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    @endif
                                    <form action="{{ route('admin.profileUpdate') }}" method="POST" role="form" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label for="user_image" class="col-md-4 col-form-label text-md-right">Profile Image</label>
                                            <div class="col-md-6">
